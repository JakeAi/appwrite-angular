import { ContinentsList, CountriesList, CurrenciesList, LanguagesList, Locale, PhonesList } from '@appwrite/common';
import { AppwriteService } from './';
import * as i0 from "@angular/core";
export declare class AppwriteLocaleService {
     ...
     * @returns {Promise}
     */
    getContinents(): Promise<ContinentsList>;
    /**
     * List Countries
     *
